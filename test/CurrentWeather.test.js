...
describe('CurrentWeather', () => {
    ...
    it('Should have a configurable condition', () => {
        const currentWeather = shallow( <CurrentWeather condition={mockData.condition} />);
        expect('Sunny').toEqual(mockData.condition);
    })

    it('Should have a configurable day and date', () => {
        const currentWeather = shallow( <CurrentWeather day={mockData.day} date={mockData.date}/>);
    ...
    it('Should have a configurable temp with tempHi and tempLo', () => {
        const currentWeather = shallow( <CurrentWeather tempHi={mockData.tempHi} tempLo={mockData.tempLo} />);
